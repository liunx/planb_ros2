#include <thread>
#include <chrono>
#include "planb_hw/camera_node.hpp"
      ...
      status_("OFF")
{
    ...
    auto handle_service =
        [this](const std::shared_ptr<rmw_request_id_t> request_header,
               const std::shared_ptr<planb_interfaces::srv::CameraInfo::Request> request,
               std::shared_ptr<planb_interfaces::srv::CameraInfo::Response> response) -> void
    {
        (void)request_header;
        (void)request;
    ...
    srv_ = create_service<planb_interfaces::srv::CameraInfo>("camera_info", handle_service);
}
...
void CameraNode::cmd_callback(const planb_interfaces::msg::Cmd &msg)
{
