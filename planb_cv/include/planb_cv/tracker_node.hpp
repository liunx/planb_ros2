...
private:
    ...
    void aruco_data_callback(const planb_interfaces::msg::ArucoMarker &msg);
    std::string status_;
    ...
    rclcpp::Publisher<planb_interfaces::msg::CoordInfo>::SharedPtr pub_data_;
    rclcpp::Subscription<planb_interfaces::msg::ArucoMarker>::SharedPtr sub_aruco_data_;
