#include "planb_cv/tracker_node.hpp"
      ...
      flag_tracking_(false)
{
    ...
    pub_data_  = this->create_publisher<planb_interfaces::msg::CoordInfo>("/planb/tracker/data", 1);
    ...
    sub_aruco_data_ = this->create_subscription<planb_interfaces::msg::ArucoMarker>(
        "/planb/aruco/data",
        1,
...
void TrackerNode::stream_callback(const sensor_msgs::msg::Image::UniquePtr msg)
{
    ...
    if (tracker_->update(frame, bbox_)) {
        planb_interfaces::msg::CoordInfo msg;
...
void TrackerNode::aruco_data_callback(const planb_interfaces::msg::ArucoMarker &msg)
{
...
void TrackerNode::cmd_callback(const planb_interfaces::msg::Cmd &msg)
{
