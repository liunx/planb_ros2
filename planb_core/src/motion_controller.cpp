...
public:
          ...
          coords_({})
    {
        ...
        pub_operate_ = this->create_publisher<planb_interfaces::msg::Operate>("/planb/hardware/operate", 1);
        sub_coordinfo_ = this->create_subscription<planb_interfaces::msg::CoordInfo>(
            "/planb/tracker/data",
            1,
...
private:
    void publish_operate(const uint8_t steering, const uint8_t accel)
    {
        ...
        planb_interfaces::msg::Operate msg;
    ...
    void coordinfo_callback(const planb_interfaces::msg::CoordInfo &msg)
    {
        if (!coords_.empty())
        {
    ...
    rclcpp::Subscription<planb_interfaces::msg::CoordInfo>::SharedPtr sub_coordinfo_;
    rclcpp::Publisher<planb_interfaces::msg::Operate>::SharedPtr pub_operate_;
};
