#include "planb_core/behaviortree_action.hpp"
...
ArucoAction::ArucoAction(const std::string &name,
    ...
    : BT::SyncActionNode(name, config),
      ...
      node_(node)
{
    pub_cmd_ = node_->create_publisher<planb_interfaces::msg::Cmd>("/planb/aruco/cmd", 1);
    ...
    sub_data_ = node_->create_subscription<planb_interfaces::msg::ArucoMarker>(
        "/planb/aruco/data",
        1,
...
BT::NodeStatus ArucoAction::get_data()
{
    ...
    rclcpp::MessageInfo msg_info;
    planb_interfaces::msg::ArucoMarker msg_data;
...
TrackerAction::TrackerAction(const std::string &name,
    ...
    : BT::SyncActionNode(name, config),
      ...
      node_(node)
{
    pub_cmd_ = node_->create_publisher<planb_interfaces::msg::Cmd>("/planb/tracker/cmd", 1);
    sub_status_ = node_->create_subscription<std_msgs::msg::String>(
...
CameraAction::CameraAction(const std::string &name,
    ...
    : BT::SyncActionNode(name, config),
      ...
      node_(node)
{
    pub_cmd_ = node_->create_publisher<planb_interfaces::msg::Cmd>("/planb/camera/cmd", 1);
    sub_status_ = node_->create_subscription<std_msgs::msg::String>(
        "/planb/camera/status",
        1,
        [](std_msgs::msg::String::UniquePtr)
...
HardwareAction::HardwareAction(const std::string &name,
    ...
    : BT::SyncActionNode(name, config),
      ...
      node_(node)
{
    pub_cmd_ = node_->create_publisher<planb_interfaces::msg::Cmd>("/planb/hardware/cmd", 1);
    sub_status_ = node_->create_subscription<std_msgs::msg::String>(
